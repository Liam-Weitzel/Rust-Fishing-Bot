...
Func _ArrayDisplayEx_WM_NOTIFY30( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	...
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $aFormats, $iFmtPars, $aColors, $aDisplay[100], $iFrom, $iTo
	...
	Switch DllStructGetData( DllStructCreate( "struct; hwnd hWndFrom;uint_ptr IDFrom;int Code; endstruct", $lParam ), "Code" )
		...
		Case -320, -321 ; $HDN_ITEMCHANGINGW, $HDN_ITEMCHANGEDW
			Return
...
Func _ArrayDisplayEx_WM_NOTIFY31( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $aFormats, $iFmtPars, $aColors, $iColCount, $aDisplay[1][1], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY32( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $iRows, $aSort_Rows, $bDef_Sort, $aFormats, $iFmtPars, $aColors, $aDisplay[100], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY33( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $iRows, $aSort_Rows, $bDef_Sort, $aFormats, $iFmtPars, $aColors, $iColCount, $aDisplay[1][1], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY34( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $iRows, $tSort_Rows, $bDef_Sort, $aFormats, $iFmtPars, $aColors, $aDisplay[100], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY35( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $iRows, $tSort_Rows, $bDef_Sort, $aFormats, $iFmtPars, $aColors, $iColCount, $aDisplay[1][1], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY36( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $aSort_Cols, $aFormats, $iFmtPars, $aColors, $iColCount, $aDisplay[1][1], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY37( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $iRows, $aSort_Rows, $bDef_Sort, $aSort_Cols, $aFormats, $iFmtPars, $aColors, $iColCount, $aDisplay[1][1], $iFrom, $iTo
...
Func _ArrayDisplayEx_WM_NOTIFY38( $hWnd, $iMsg, $wParam, $lParam, $iIndex, $pData )
	If $iMsg <> 0x004E Then Return DllCall( "comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hWnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam )[0] ; 0x004E = $WM_NOTIFY
	Local Static $tText = DllStructCreate( "wchar[260]" ), $pText = DllStructGetPtr( $tText ), $iIdx = 0, $aArray, $iRows, $tSort_Rows, $bDef_Sort, $aSort_Cols, $aFormats, $iFmtPars, $aColors, $iColCount, $aDisplay[1][1], $iFrom, $iTo
